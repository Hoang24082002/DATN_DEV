...
public class ProductObject {
	...
	private int product_created_author_id;
	private short product_favorite;
	...
	public int getProduct_created_author_id() {
		return product_created_author_id;
	}

	public void setProduct_created_author_id(int product_created_author_id) {
		this.product_created_author_id = product_created_author_id;
	}

	public short getProduct_favorite() {
		return product_favorite;
	}

	public void setProduct_favorite(short product_favorite) {
